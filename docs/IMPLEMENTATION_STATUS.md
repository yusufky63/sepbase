...
Every unchecked item is pending. See `docs/V3_ACCEPTANCE_MATRIX.md`: only rows carrying explicit evidence pass. V3 deployment, funded V3 wallet/browser execution, paid-x402 runtime, audit, soak and operations rows remain `NOT RUN` or explicitly blocked.
