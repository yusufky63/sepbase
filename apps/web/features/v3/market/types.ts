...
> = {
  "marketplace-approve": { group: "ACCOUNT", title: "Approve one name for market", executeLabel: "Simulate per-token approval" },
  "fixed-list": { group: "FIXED", title: "List name", executeLabel: "Simulate and list" },
  "fixed-update": { group: "FIXED", title: "Update listing", executeLabel: "Simulate update" },
  "fixed-cancel": { group: "FIXED", title: "Cancel listing", executeLabel: "Simulate cancellation" },
  "fixed-invalidate": { group: "FIXED", title: "Invalidate stale listing", executeLabel: "Simulate invalidation" },
  "fixed-buy": { group: "FIXED", title: "Buy listed name", executeLabel: "Simulate and buy" },
  "offer-create": { group: "OFFER", title: "Create escrowed offer", executeLabel: "Simulate offer" },
  "offer-cancel": { group: "OFFER", title: "Cancel offer", executeLabel: "Simulate cancellation" },
  "offer-accept": { group: "OFFER", title: "Accept offer", executeLabel: "Simulate acceptance" },
  "offer-invalidate": { group: "OFFER", title: "Invalidate stale offer", executeLabel: "Simulate invalidation" },
  "auction-create": { group: "AUCTION", title: "Create English auction", executeLabel: "Simulate auction" },
  "auction-bid": { group: "AUCTION", title: "Place auction bid", executeLabel: "Simulate bid" },
  "auction-cancel": { group: "AUCTION", title: "Cancel auction", executeLabel: "Simulate cancellation" },
  "auction-finalize": { group: "AUCTION", title: "Finalize auction", executeLabel: "Simulate finalization" },
  claim: { group: "ACCOUNT", title: "Claim proceeds or refund", executeLabel: "Simulate claim" },
};
